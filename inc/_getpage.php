...
function getSql($sql, $page_size, $page_querystring){//分頁用
	global $page, $sql, $count, $page_count, $pre, $next, $querystring, $HS, $ID, $PW, $DB, $db, $nextLoadPage; //global全域變數
	$nextLoadPage = 1;
...
/////////////////*/
	...
	if($page != 1){
		echo  '<li><a href=?'.$querystring.'page='.$pre.' onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('."'imageP'".','."''".','."'images/page_prevover.png'".')"><img src="images/page_prev.png" height="18" width="31" name="imageP" alt=""></a></li>';    
	}
	$viewpage = 6;
	...
	if($page < $page_count){
		echo '<li><a href=?'.$querystring.'page='.($page+1).' onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('."'imageN'".','."''".','."'images/page_nextover.png'".')"><img src="images/page_next.png" height="18" width="31" alt="" name="imageN"></a></li>';
	}
}
