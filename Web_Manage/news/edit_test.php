...
if($row){
	...
	$video_url = htmlspecialchars($row["video_url"], ENT_COMPAT);
	$content = $row["news_content"];
	$pic = $row["news_banner"];
	$is_show = $row["news_isshow"];
	$inrightshow = $row["news_inrightshow"];
	$slidershow = $row["news_slidershow"];
...
$(document).ready(function(){
	...
	if($('#type option:selected').text() != "Video/影音")
		$('#table .video_url').hide();
	else
		$('#table .video_url').show();
	
	//add by Stand(20150124): 顯示及隱藏影片嵌入網址欄位
        ...
        <div class="accordion ">
            ...
            <input type="hidden" name="cid" value="<?php echo $id; ?>">
				<div class="listshow_L">	
					<table width="100%" border="0" cellpadding="0" cellspacing="3" id="table">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input style="width: 98.5%;" type="text" name="title" id="title" size="50" value="<?php echo $title; ?>"/></td>
                        </tr>
						<tr>
						...
						<tr class="video_url">
                            <td width="30" valign="top"><h4 class="input-text-title">影片嵌入網址</h4></td>
                            <td><input style="width: 98.5%;" type="text" name="video_url" id="video_url" size="50" value="<?php echo $video_url; ?>"/></td>
                        </tr>
                        <!--<tr>
                            <td width="150" valign="top"><h4 class="input-text-title">作者</h4></td>
                        ...
                        <tr>
                            ...
                            <td><textarea name="content" id="content" class="ckeditor" height="2000px"><?php echo $content; ?></textarea></td>
                        </tr>
                        <tr>
                            <td width="30"></td>
				...
				<div class="listshow_R">
                    <table width="100%" border="0" cellpadding="0" cellspacing="3">
                        ...
                        <tr>
						 ...
						 <tr>
                            <td width="150" valign="top"><h4 class="input-text-title">是否為單元企劃</h4></td>
                            <td><input type="checkbox" name="slidershow" id="slidershow" <?php echo ($slidershow == 1) ? "checked" : ""; ?> value="1" />
                                &nbsp;
                                單元企劃 </td>
                        </tr>
                        <tr>
