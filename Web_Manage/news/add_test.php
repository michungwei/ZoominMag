...
$(document).ready(function(){
	$("form").submit(function(){
		...
		if(re){re = isnull("resource", "資料來源", 0, 1, 999);}
				...
				<div class="listshow_L">
                    <table width="100%" border="0" cellpadding="0" cellspacing="3" id="table">
                        ...
                        <tr>
                            ...
                            <td><input style="width: 98.5%;" type="text" name="title" id="title" size="100%" value=""/></td>
                        </tr>
						<tr class="video_url">
                            <td width="30" valign="top"><h4 class="input-text-title">影片嵌入網址</h4></td>
                            <td><input style="width: 98.5%;" type="text" name="video_url" id="video_url" size="100%" value=""/></td>
                        </tr>
                        <!--<tr>
						...
						<tr>
                            <td width="30" valign="top"><h4 class="input-text-title">資料來源</h4></td>
                            <td><input style="width: 98.5%;" type="text" name="resource" id="resource" size="100%" value=""/></td>
                        </tr>
                        <tr>
                            <td width="30"></td>
				...
				<div class="listshow_R">
                    <table width="100%" border="0" cellpadding="0" cellspacing="3">
						...
						<tr>
                            ...
                            <td><input type="checkbox" name="slidershow" id="slidershow" value="1"/>
                                &nbsp;
                                單元企劃 </td>
                        </tr>
                        <tr>
